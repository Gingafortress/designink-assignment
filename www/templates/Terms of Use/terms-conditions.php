...
The website available at http://www.freepik.com, http://www.freepik.es including all sub domains, or sections (“Website”) is operated by Graphic Resources, S.L. (“FreePik”), registered in the Commercial Registry of Málaga, volume 4994, sheet 217, page number MA-113059, with Tax Number B-93183366 and registered office at Molina Lario 13 street, 5th floor, 29015 Málaga, España.

These terms of use (“Terms”) govern the access, browsing and use of the Website by their users (“User” or “Users”, as applicable); the download and use of certain content owned by FreePik; as well as the services rendered through the Website (“ Service” or “Services”, as applicable).
...
FreePik may modify the Terms at any time and thus we recommended that the Terms are reviewed on a regular basis by the User. The date at the beginning of these Terms refers to the latest update of these Terms, which will be applicable from the date of publication.

Some Services provided through the Website may be subject to specific conditions or instructions that must be accepted by the User prior to the provision of the relevant Service. These specific conditions may be imposed by FreePik or by third parties. Such specific conditions shall apply in addition to the Terms and in case of conflict shall supersede the Terms. Accordingly the User must read and accept such specific conditions before the provision of the relevant Service.
...
The Services may search and locate, as a result of the search performed by the User, third party Content offered for free over the Internet ("Third Party Content"). However, the Service may also provide, in the result of that search, Contents owned by or licensed to FreePik (“ FreePik Content”); as well as third-party Content not offered free of charge (“Sponsored Content"). Sponsored Content is duly differentiated and identified on the search results. FreePik Content can be downloaded through the Website.
...
The rights granted to the User under these Terms are personal and shall not be assigned to any third party (including affiliates or entities part of the same group of companies) totally or partially, by any mean, without the prior, express and written consent from FreePik.

When providing the Services, FreePik can publish advertising either related or not to the searched Contents, which is expressly accepted by the User.
3. REGISTRATION
...
The User is responsible for all operations carried out through the User’s account through any device. If the User suspects that another user is using his account he/she should immediately inform FreePik.

FreePik may suspend or cancel the account of the User if it considers that the User has breached these Terms.
4. CONTENT

The Services allow Users to:

    Search for content that may result in Third Party Content, FreePik Content and/or Sponsored Content.
    Download FreePik Content.

4.1. Third Party Content and Sponsored Content

Regarding the Third Party Content and Sponsored Content, FreePik’s role is limited to complete the search requested by the User and to provide such Content as a search result with a link to the relevant website together with specific related information. In some cases, in order to provide the User a better user experience and facilitate returning to the Services, the link can be presented within a FreePik frame, which can be removed by the User at any time.

FreePik is not the provider of the Third Party Content or the Sponsored Content and does not present itself as owner of such Content. Furthermore, displaying the search result and the link do not imply any relationship between FreePik and the third party responsible for the Third Party Content or Sponsored Content.

FreePik does not select, examine, control, guarantee, approve, sponsor or identify itself in any form with the Third Party Content or the Sponsored Content resulting of the searches made by the Users. The Third Party Content and the Sponsored Content are the sole responsibility of the third parties that make them available to the public over the Internet.

The User will be able to access the corresponding third party websites and download the Third Party Content and/or the Sponsored Content under the terms and conditions established by such third parties. FreePik shall not be a party or be involved in any way in the relationship between the User and the corresponding third party. The User undertakes to read and comply with the terms and conditions established by such third parties for the download and use of the Third Party Content and the Sponsored Content.

FreePik is not a party and does not take part in the relationship between the User and the third party that offers the Third Party Content or the Sponsored Content, and is not directly or indirectly responsible for the performance, omissions, errors, negligence or breaches of the Users or such third parties. Any claim from the Users regarding the Third Party Content or the Sponsored Content must be addressed to the third parties, which offer them in the linked website.
4.2. FreePik Content

The FreePik Contents are offered under the conditions stated from time to time in the Website (including, without limitation, restrictions to the downloads of FreePik Content each day) and are licensed in the terms set out in Section 7 and/or in Section 8, as applicable.

4.3. Enquiries and Information about the Content

If you have any question regarding any Content or believe that it infringes any right, that it does not comply with these Terms, or that is inappropriate, you can do so by contacting FreePik as indicated in Section 10 or following the instructions provided on the Website for a copyright complaint.
5. RESPONSIBILITY

The User acknowledges and agrees that uses the Website and its Services at the User’s own risk and under the User’s responsibility and therefore FreePik does not accept any responsibility for misuse or use in breach of these Terms.

The User will be responsible for any damages to FreePik resulting from the User’s use of the Website and the Services in breach of the Terms and accepts to indemnify FreePik and its directors, employees, agents and representatives from any liability in which they may incur resulting from the User’s breach of these Terms.

FreePik does not warrant the availability or continuity of the Website and the Services, neither its reliability, quality, completeness, accuracy or whether they are fit for a specific purpose or activity.

As way of example and without limitation, FreePik shall not be liable for any damages that may result from:

    Interruptions, viruses, technical problems, interferences, omissions, unavailability, power cuts, failure of the telecommunication networks or the User’s equipment which are not FreePik’s responsibility.
    ...
    Any other event beyond FreePik’s direct control.
...
In accordance with Section 4 above regarding Third Party Content and Sponsored Content, FreePik acts exclusively as a provider of a search service as requested by the User, without assuming any responsibility for search results.

The insertion of links in the Services does not imply any relationship, recommendation or supervision by FreePik of the linked website and accordingly, FreePik does not accept any liability in relation to the content of any linked website except in the specific circumstances provided by applicable law.
6. INTELLECTUAL PROPERTY

All intellectual property rights over the Website, the Services, and/or the FreePik Content, its design, and source code, and all content included in any of them (including without limitation text, images, animations, data bases, graphics, logos, trademarks, icons, buttons, pictures, videos, sound recordings, etc.) belong or are licensed to FreePik.
...
The Third Party Content and the Sponsored Content are protected by intellectual property rights, as appropriate, and belong to their owners. Although the Services can locate and provide access to these Contents, its download and use is subject to the conditions set by the relevant third party. FreePik is not the owner and cannot grant any license or authorization in relation to the Third Party Content or Sponsored Content. The User must obtain authorizations that are, in each case, required to use any Third Party Content or any Sponsored Content.

If the third party holder of a Third Party Content or Sponsored Content does not want to be included in FreePik search results, the third party can contact FreePik as indicated in Section 10. Regarding a specific Third Party Content or Sponsored Content appearing as search result, you can use the copyright complain that appears next to the result.
7. APPLICATION END USER LICENSE AGREEMENT

FreePik authorizes the User to download and use the FreePik Content under the terms of this license. FreePik reserves all rights over the FreePik Content not expressly granted in this license to the User.
...
The license of the FreePik Content shall be free provided that any use of the FreePik Content by the User is credited to FreePik as stated by FreePik from time to time. For any use of the FreePik Content without the credit to FreePik, the User must purchase a subscription (hereinafter, the “ Subscription”) in the Website and download the FreePik Content during the term of any such Subscription. Conditions in Section 8 shall apply to the purchase of the Subscription.
...
The User rights under this license will end automatically without any notice if the User breaches any of the Terms. In case of termination of the license, the User shall cease using FreePik Content and will destroy every copy, whether total or partial, thereof.
...
The Subscriptions available for the FreePik Content are offered in the Website where the relevant information, price and conditions are included (including, without limitation, restrictions to the number of downloads of FreePik Content each day). FreePik can modify at any time the Subscriptions offered, offering with new Services (to which, unless otherwise stated, these Subscription Terms shall apply) or ceasing to offer any of the Services. The Subscriptions are personal, shall not be assigned to third parties and no third parties other than the User shall be allowed to use the FreePik Content (including as third parties, for these purposes, affiliates or entities part of the same group of companies)

The price for the Subscription is stated in Euros in the Website and includes, if applicable, the relevant Value Added Tax. FreePik is entitled to modify the price for any Subscription at any time. FreePik shall apply the price stated in the Website at the time of the submission of the order of the Subscription by the User.

The User shall pay the Subscription in advance through Paypal or credit/debit card, as stated in the Website. To purchase and pay the Subscription, the User shall follow the instructions stated in the Website. The processing of the payment information and data through Paypal or credit/debit card is made within third parties sites. When ordering any Subscription, the User authorizes FreePik to collect the corresponding price through the chosen payment method. The Subscription shall not be activated until FreePik has received the payment or the payment has been authorized by the relevant financing entity. After that, the Subscription shall be in force for the term purchased by the User.

Unless otherwise stated in these Subscription Terms, the Subscriptions shall be automatically and successively renewed at the expiration of its term, unless the User cancels the renewal of the Subscription before its expiration. FreePik shall charge the corresponding price by the same initial payment method. FreePik may modify the price for the renewal of the Subscription, provided that the User is informed with, at least, one-month prior notice.
...
After the purchase of the Subscription, the User may use the FreePik Content without crediting FreePik. The rest of conditions stated in Section 7 shall still be applicable.

As the FreePik Content is digital content, no cancellation right shall apply, without prejudice to the guarantees stated in the consumers’ regulations that may be applicable.
9. CHANGES AND CLOSURE OF THE WEBSITE

FreePik may, at any moment, and without incurring in any responsibility towards the User, modify the content of the Website or the Services, limit or modify the conditions or cease to provide some or all the Services and features available or deactivate and delete all or some of the User accounts and their corresponding information. However, FreePik will comply with its obligations regarding the keeping of records in relation of certain transactions for the relevant period as provided by applicable law or refund the Users of Subscriptions in force at that time with the proportional part of the price not accrued before the termination.
...
You may contact FreePik for any query or claim in the following website address: www.freepik.com/contact
